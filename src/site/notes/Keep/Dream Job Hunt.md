...
Learn https://www.youtube.com/playlist?list=PL1QBBmOuvLxt2bsWDlP2qGsm3r6Y2k-fH

Set Up a Task Management System in Todoist or an other app of your choice or even paper using https://www.loom.com/share/0ffc812f20e04d66baf1da9dcc0df840

Then Create a Task Management System like so:

![Pasted image 20260907130233.png](/img/user/Attachments/Pasted%20image%2020260907130233.png)

**For the First Week section:**

![Pasted image 20260907130245.png](/img/user/Attachments/Pasted%20image%2020260907130245.png)

**For the Second Week and Beyond Section:**

![Pasted image 20260907130314.png](/img/user/Attachments/Pasted%20image%2020260907130314.png)

![Pasted image 20260907130324.png](/img/user/Attachments/Pasted%20image%2020260907130324.png)


Please note that for each task that has the purple “Monday” due date in it you need to type in “Each Workday from next Monday” as the due date like this:

![Pasted image 20260907130339.png](/img/user/Attachments/Pasted%20image%2020260907130339.png)

For the last three tasks, leave them without a due date:

![Pasted image 20260907130351.png](/img/user/Attachments/Pasted%20image%2020260907130351.png)

We will add a due date later when these tasks show up in our process.

**For the After Landing an Interview Section:**

![Pasted image 20260907130403.png](/img/user/Attachments/Pasted%20image%2020260907130403.png)

Leave all these without a due date as well.

Now open the Today view from the Sidebar:

![Pasted image 20260907130413.png](/img/user/Attachments/Pasted%20image%2020260907130413.png)

It will show your tasks for Today:

![Pasted image 20260907130423.png](/img/user/Attachments/Pasted%20image%2020260907130423.png)
...
The first step is to understand what success looks like and what we really want. Neglecting this step will get you to interview and work at companies that are not a fit. And this may lead to years or even decades wasted.

So, let’s first define your dream and work backward to get it. And don’t worry about getting it perfect at first; it will evolve over time.

Fill this out:
Define 3 max of each of the following (the fewer the better)

- Positions (This is called your horizontal expertise) — the more specific the better
    ...
    - Technical Recruiter
    - Engineering Manager
- Industries (This is called your vertical expertise) — the more specific the industry the better
    ...
    - Education
    - Personal Growth
- Locations (Optional) — If you are choosing remote make sure the working hours are in your time zone. For example, if you are in Pakistan you may choose open positions that are advertised in the EMEA or Asia-Pacific region.
    ...
    - Dubai (Remote)
    - Malaysia (Remote)
- The position and industry you choose should be:
...
Employers traditionally create a scorecard for every position. Check out [this resource](https://coda.io/@hlamex/copy-of-victors-a-player-hiring-guide) to understand the process from the employer's perspective.

Now, let’s reverse engineer the scorecard into resume bullet points that will check all the boxes.

Write your resume for each of the niches. These will become your starting templates.

We must start with building one resume for each of our niches.

To make a good resume, read these:

Read https://cultivatedculture.com/resume-action-words/
Read https://www.inc.com/bill-murphy-jr/google-recruiters-say-these-5-resume-tips-including-x-y-z-formula-will-improve-your-odds-of-getting-hired-at-google.html

## 4. LinkedIn and Online Presence:

### LinkedIn

<aside>  
ℹ️ You’ve written your resume. But very few people are going to see it (if anyone).

Today, people prefer LinkedIn to evaluate a candidate over a formal resume.

Let’s go through the LinkedIn optimization checklist.

</aside>

Read https://cultivatedculture.com/linkedin-profile-tips/
Watch https://www.youtube.com/watch?v=B4OhuzwLc9o&ab_channel=JeffSu

Then, focus your LinkedIn profile on your most impressive accomplishments. Be as concrete as possible e.g. “ranked third in the nation”, “increased annual donations 100%”. Cut the rest. It’s better to have two impressive achievements than two impressive achievements and three weak ones. Finally, search yourself on Google and do anything you can to make the results look good.

Copy bullet points from your resume that you created using https://www.inc.com/bill-murphy-jr/google-recruiters-say-these-5-resume-tips-including-x-y-z-formula-will-improve-your-odds-of-getting-hired-at-google.html

### Online Presence:

Update All Your Social Media to reflect your LinkedIn

### Github

Have at least 5 Projects uploaded on GitHub in your niche

### Optional: Create Website

You can do this with Wordpress

<aside>  
ℹ️ Our goal is to create a profile that makes employers think, “_Where was this person this entire time!? She is exactly what we’ve been looking for for so long._”

And the key to eliciting this response is understanding what the employer wants. Thus, we will be reverse engineering their “scorecard” for your dream role position and make you check all the boxes before the interview even begins.

</aside>

## 5. Ask Close Connections:

_If you already know someone in the industry who can hire people, then ask for a meeting_  
to discuss opportunities in the industry. This is close to going directly to an interview, skipping all the screening steps. Remember, there doesn’t need to be an open position – employers will often create positions for good people.

If your connection is not able to refer you, then ask them to introduce you to people in the industry who _are_ able to hire. Then follow step **11.**

Note this down somewhere.

## 6. Connect with Important People
ℹ️ It’s time to research people who are 5-10 years ahead of you. These guys have walked the walk and have achieved what you want to achieve.

You should know who these people are and ask them for advice.

First, they can give you advice on your career path. Is it sound? How does it feel to be in their shoes?

Second, they will tell you great companies you should consider applying to. And maybe even make introductions.

And finally, and most importantly, they may be _the people_ you will want to work with.

# To Do Second Week and Onward

## 7. Creating Content

- Create 1 Blog Post on Each Monday
- Do 0.5 Guest Post Each Tuesday
- Make 0.5 Open-Source Contribution Each Wednesday
- Publish 0.25 Research Papers Each Thursday
- Post 1 time on LinkedIn and engage with 3 posts Each Friday.
...
![](https://cultivatedculture.com/wp-content/uploads/2019/05/Example-of-LinkedIn-post-with-traction-and-engagement.png)
...
This is all about discovering the most promising companies and opportunities. Are you excited about their mission and products? Who would you be working with there? Are these the people you’d like to learn from?

### 8a. Find 10 positions that match loosely to your niche — they might not be a perfect match.
Save these somewhere.

### 8b. Create Tailored Resumes:

You need to create 1 for each of the 10 Positions you found.

### 8b. Find 3 Positions Each Day that match your exact niche:

Save this info somewhere.

## 9. Apply
  
🤖 You don’t want to end up in the pile of resumes never-to-be-seen… Competing for a hot position with hundreds of other applicants is an uphill battle. And if you’ve applied to maaaany jobs online with no response already, then this may change everything for you.

There are two ways to go about your application. You should do both to see what works for you.

### Method A: Via the Traditional Route

<aside>  
ℹ️ **Method A: Apply Directly**

You need to apply to 10 jobs daily. Refrain from LinkedIn’s “Easy Apply”.  
This is the traditional route online. To do this, you will not need to customize your resume specifically for the position you are applying for. Let’s submit the application!

</aside>

[Use this resource to write an effective cover letter.](https://cultivatedculture.com/cover-letter/)

### Method B: **Referrals**  
ℹ️ **Method B: Referrals**  
Here, we are first going to connect with people who have influence over the hiring project. We will seek career advice as opposed to directly asking about a specific position. The insights from those conversations will fuel our Value Validation Project. More on that later. By then, your application process has already begun!

### _Find Influencers_

Now open your notes where you saved the 3 open jobs.
...
In the LinkedIn search bar, I want you to plug in the company name from the database.

With that in mind, I usually look for the person with a title that is one level up from the position that I’m looking for. Save this info somewhere.

### **Obtaining Contact Info**

Here are 3 strategies you can use to find almost anyone’s email address:

1. _**LinkedIn:**_
    
    It could be present on LinkedIn
    
2. _**Reverse Lookup**_
    
    Head over to [Mailscoop](https://mailscoop.io/) and enter the first and last name of the person you are searching for, as well as their company's website.
    
    You can also use [Hunter.io](http://Hunter.io) or some other tool.
    
3. _**Matching Formats**_
    
    If that doesn’t work, you can try finding someone else’s email at the company and use that format reverse engineering your target email address.Once you have the format, you can use [MailTester](http://mailtester.com/) to confirm your target email address.
...
_**Subject:** Quick Question_

_Hi Austin,_

_My name is [Your Name] and I found your info while I was looking for people who made the jump into tech from a non-traditional background. Your experience transitioning from healthcare to Microsoft really stood out to me._

_I'm sure that transition wasn't easy! I'd love to hear more about your journey, some of the obstacles you faced, and ask you a few questions._

_I know you're busy and your time is valuable, no need to respond in depth. If you do have a few minutes to chat, I'd be really grateful. If not, no worries! Either way, have a fantastic week._
...
I like to ask them several softballs to get things warmed up and then hit them with a few questions they are guaranteed to remember.

Here is a quick set that I’ve had success with in the past (I've found the last one really seems to stick):

1. I saw you worked at _[Previous Companies]_. How did you end up going from *[First Industry]*to becoming interested in _[Current Company]_?
...
[Check out this article with 12 VVP example.](https://cultivatedculture.com/value-validation-project/)

Explore Austin’s starter kit with examples, references, and tutorials to create a great Value Validation Project.

[Get The Value Validation Project Starter Kit - Cultivated Culture](https://cultivatedculture.com/vvp-starter-kit-purchase/)

### The Format

_Presentations in Google Slides or PowerPoint are great for this._

_That said, the best medium you can use is the one that you feel the most comfortable with and is the most relevant to your target job._
...
When they do get back to you, they will not only bring up the opening but they will ask you if you're interested. Kindly accept and play it cool. You’re in!

# To Do after Landing the Interview

## **14. How To Breeze Through The Interview Process:**

One of the easiest ways to be a better interviewer is to [prepare for the most obvious questions](https://www.fundera.com/blog/creative-interview-questions).
...
2. In particular, work out which problems you will need to solve for the organisation. To figure this out, you’ll probably need to do some desk research – [here’s a simple guide](https://www.themuse.com/advice/the-ultimate-guide-to-researching-a-company-preinterview) – then speak to people in the industry.
...
_Eventually, I was offered a position at my current company (a promotional analytics company in New York). During my tenure there I have grown my book of business by 467%, spearheaded the creation of an internal group dedicated to marketing the company on the internet, and helped close the 2nd largest deal in company history._

_However, the company has restructured several times since I was brought on. I've had 3 different managers over the past year, as well as 3 titles with different sets of responsibilities. I'm looking for something a bit more stable and has been somewhere that I have wanted to work since I got into this industry. I'm really excited to have this opportunity._

_**Pro Tip**: You are telling a story. Don’t be afraid to embellish a bit. I’m not saying you should lie or make up stories, but you want to sell yourself and you can bet your butt that your competition isn’t afraid to inflate their credentials. It doesn't hurt to practice either. As blogger Ryan Robinson adds, “rehearsing and building upon my story over the years, is one of the ways I've honed my ability to [write a blog post](https://www.ryrob.com/how-write-blog-post/) that tells a compelling narrative about why my clients should hire me.”_

### **2. Behavioral Questions**

Next up is the dreaded set of behavioral questions. The ones meant to tease out your thought process and your ability to be a “team player,” as well as [why you're interested in this specific role](https://cultivatedculture.com/why-do-you-want-to-work-here/). This is the part where our educated “guesses” are going to come in handy.

The behavioral section is broken down into two parts that I call _Standard Questions_and _Company Specific Questions_. Let's start with the former.
...
If you can answer these 6 questions, you could handle 9 out of 10 interviews with no other preparation and be totally fine. Just follow the same set of rules I mentioned above in the _Tell Me About Yourself_section:
...
This will pull up a list of reviews from everyone who interviewed and received an offer for that position. The general comments are really helpful, but we want to focus on a section called _Interview Questions_towards the bottom. I usually comb through 10 – 15 of these and add all of the interview questions into a Word doc so I can answer them later:
...
1. **When you meet an employer, ask lots of questions to understand their challenges.**  
    Discuss how you might be able to contribute to these challenges
2. **Prepare your three key selling points ahead of meetings.** These are the messages you’ll try to get in during the discussion. For instance: 1) I have done this work successfully before, 2) I am really excited about this company, 3) I have suggestions for what I could work on.
3. **Focus on what’s most impressive.** What sounds better: “I advised Obama on energy policy” or “I advised Obama on energy policy, and have worked as a high school teacher the last three years”?
4. **Prepare concrete facts and stories to back up your three key messages.** For instance, if you’re applying to be a web engineer, rather than “I’m a hard worker”, try “I have a friend who runs an organization that was about to get some press coverage. He needed to build a website in 24 hours, so we pulled an all-nighter to build it. The next day we got 1,000 sign-ups.” Rather than say “I really want to work in this industry”, tell the story of what led you to apply. Stories and concrete details are far more memorable than abstract claims.
...
6. **Practice the meeting, from start to finish.** Meet with a friend and have them ask you five interview questions, then practice responding quickly.

You can research the company’s interview process on Glassdoor.

- https://almanac.io/docs/interview-prep-answer-interview-questions-with-key-results-cF4TwddXLtvGbfSjAyKEk8EPRLN2ktmk
- https://cultivatedculture.com/how-to-get-a-job-anywhere-no-connections/
- https://almanac.io/docs/job-interview-prep-hiring-manager-and-panel-interviews-MMgVflUJg315rse1nWcVskeyb8d1I5S7
    
## **15. Say Thank You!**

While we're on the subject, be absolutely sure to [send a thank you email](https://cultivatedculture.com/interview-thank-you-email/) to everyone you interviewed with. Also include a personal touch to each one (something that you gained from that last question).

## **16. Following Up & What To Do If They Say No**

The rule of thumb for [following up after an interview](https://careersidekick.com/follow-up-after-interview-no-response/) is one business week. If you interviewed on a Tuesday, wait until the next Tuesday to email them (as JT O'Donnell says, [never send a nudge on a Monday!](http://www.careerealism.com/email-unanswered-follow-up/)). When you do, don't push or be blunt. Keep it short and sweet:
...
_Thank you again for your continued consideration.
Best
_Austin_
